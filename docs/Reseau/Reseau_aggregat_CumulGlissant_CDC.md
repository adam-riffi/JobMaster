# Cahier des Charges — Reseau / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs reseau — utilisé pour les analyses de tendance.
...
- Table agrégat glissante : `£TD_HISTO.reseau_aggr_kpi_journalier`
