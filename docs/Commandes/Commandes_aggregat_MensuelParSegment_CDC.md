# Cahier des Charges — Commandes / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE commandes par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£BQ_HISTO.commandes_aggr_journalier`
