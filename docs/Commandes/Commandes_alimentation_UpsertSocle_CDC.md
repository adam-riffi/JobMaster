# Cahier des Charges — Commandes / Alimentation / UpsertSocle
...
Alimentation du SOCLE commandes depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.commandes`

---

## Règles de gestion

- Clé de jointure : `id_commande`
