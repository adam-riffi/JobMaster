# Cahier des Charges — Commandes / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs commandes — utilisé pour les analyses de tendance.

---

## Sources souhaitées

- Table historique : `£BQ_HISTO.commandes_histo`

---

## Cibles souhaitées

- Table agrégat glissante : `£BQ_HISTO.commandes_aggr_journalier`
