# Cahier des Charges — Commandes / Import / TraitementBatch
...
Chargement en masse de tous les fichiers commandes validés dans la table staging puis archivage.

---

## Sources souhaitées

- Zone de travail : `C:\data\commandes\work`
...
- Table staging chargée : `£BQ_TMP.staging_commandes`
- Fichiers archivés dans `C:\data\commandes\archive`
