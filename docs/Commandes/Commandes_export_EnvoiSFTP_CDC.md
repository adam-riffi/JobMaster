# Cahier des Charges — Commandes / Export / EnvoiSFTP
...
Envoi des fichiers CSV commandes extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\commandes\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/commandes/out`
