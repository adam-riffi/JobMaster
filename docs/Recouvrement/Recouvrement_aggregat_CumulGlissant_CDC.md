# Cahier des Charges — Recouvrement / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs recouvrement — utilisé pour les analyses de tendance.

---

## Sources souhaitées

- Table historique : `£TD_HISTO.creances_histo`

---

## Cibles souhaitées

- Table agrégat glissante : `£TD_HISTO.recouvrement_aggr_mensuel_statut`
