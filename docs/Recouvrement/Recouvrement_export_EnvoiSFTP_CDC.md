# Cahier des Charges — Recouvrement / Export / EnvoiSFTP
...
Envoi des fichiers CSV recouvrement extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\recouvrement\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/recouvrement/out`
