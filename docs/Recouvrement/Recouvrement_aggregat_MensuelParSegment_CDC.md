# Cahier des Charges — Recouvrement / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE creances par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£TD_HISTO.recouvrement_aggr_mensuel_statut`
