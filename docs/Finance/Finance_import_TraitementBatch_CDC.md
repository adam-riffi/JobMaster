# Cahier des Charges — Finance / Import / TraitementBatch
...
Chargement en masse de tous les fichiers finance validés dans la table staging puis archivage.

---

## Sources souhaitées

- Zone de travail : `C:\data\finance\work`
...
- Table staging chargée : `£BQ_TMP.staging_finance`
- Fichiers archivés dans `C:\data\finance\archive`
