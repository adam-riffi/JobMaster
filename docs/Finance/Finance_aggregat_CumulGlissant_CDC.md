# Cahier des Charges — Finance / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs finance — utilisé pour les analyses de tendance.
...
- Table agrégat glissante : `£BQ_HISTO.finance_aggr_mensuel_rubrique`
