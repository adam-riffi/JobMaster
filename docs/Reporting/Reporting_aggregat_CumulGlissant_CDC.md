# Cahier des Charges — Reporting / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs reporting — utilisé pour les analyses de tendance.

---

## Sources souhaitées

- Table historique : `£BQ_HISTO.kpi_global_histo`

---

## Cibles souhaitées

- Table agrégat glissante : `£BQ_HISTO.reporting_aggr_mensuel_direction`
