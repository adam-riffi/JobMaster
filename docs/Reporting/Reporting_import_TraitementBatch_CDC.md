# Cahier des Charges — Reporting / Import / TraitementBatch
...
Chargement en masse de tous les fichiers reporting validés dans la table staging puis archivage.

---

## Sources souhaitées

- Zone de travail : `C:\data\reporting\work`
...
- Table staging chargée : `£BQ_TMP.staging_kpi_global`
- Fichiers archivés dans `C:\data\reporting\archive`
