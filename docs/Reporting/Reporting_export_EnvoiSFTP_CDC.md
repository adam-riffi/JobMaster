# Cahier des Charges — Reporting / Export / EnvoiSFTP
...
Envoi des fichiers CSV reporting extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\reporting\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://direction/reporting/out`
