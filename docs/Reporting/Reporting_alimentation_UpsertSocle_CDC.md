# Cahier des Charges — Reporting / Alimentation / UpsertSocle
...
Alimentation du SOCLE kpi_global depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.kpi_global`

---

## Règles de gestion

- Clé de jointure : `id_kpi`
