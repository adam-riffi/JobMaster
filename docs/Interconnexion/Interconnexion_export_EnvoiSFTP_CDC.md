# Cahier des Charges — Interconnexion / Export / EnvoiSFTP
...
Envoi des fichiers CSV interconnexion extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\interconnexion\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/interconnexion/out`
