# Cahier des Charges — Interconnexion / Alimentation / UpsertSocle
...
Alimentation du SOCLE interconnexion depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£TD_VUES.interconnexion`

---

## Règles de gestion

- Clé de jointure : `id_interconnexion`
