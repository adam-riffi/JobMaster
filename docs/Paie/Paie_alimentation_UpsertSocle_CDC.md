# Cahier des Charges — Paie / Alimentation / UpsertSocle
...
Alimentation du SOCLE paie_employes depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£TD_VUES.paie_employes`

---

## Règles de gestion

- Clé de jointure : `id_paie`
