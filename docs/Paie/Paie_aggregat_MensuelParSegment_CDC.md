# Cahier des Charges — Paie / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE paie_employes par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£TD_HISTO.paie_aggr_mensuel_direction`
