# Cahier des Charges — Paie / Import / TraitementBatch
...
Chargement en masse de tous les fichiers paie validés dans la table staging puis archivage.

---

## Sources souhaitées

- Zone de travail : `C:\data\paie\work`
...
- Table staging chargée : `£TD_TMP.staging_paie`
- Fichiers archivés dans `C:\data\paie\archive`
