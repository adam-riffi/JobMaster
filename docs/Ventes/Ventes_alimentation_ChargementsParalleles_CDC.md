# Cahier des Charges — Ventes / Alimentation / ChargementsParalleles
...
Chargement simultané du SOCLE et de la table historique ventes pour optimiser les temps de traitement.
...
- SOCLE : `£BQ_SOCLE.ventes`
- Historique : `£BQ_HISTO.ventes_histo`
