# Cahier des Charges — Ventes / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs ventes — utilisé pour les analyses de tendance.

---

## Sources souhaitées

- Table historique : `£BQ_HISTO.ventes_histo`

---

## Cibles souhaitées

- Table agrégat glissante : `£BQ_HISTO.ventes_aggr_mensuel_canal`
