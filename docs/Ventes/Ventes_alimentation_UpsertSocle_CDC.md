# Cahier des Charges — Ventes / Alimentation / UpsertSocle
...
Alimentation du SOCLE ventes depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.ventes`

---

## Règles de gestion

- Clé de jointure : `id_vente`
