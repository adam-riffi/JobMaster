# Cahier des Charges — Produits / Alimentation / UpsertSocle
...
Alimentation du SOCLE produits depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.produits`

---

## Règles de gestion

- Clé de jointure : `id_produit`
