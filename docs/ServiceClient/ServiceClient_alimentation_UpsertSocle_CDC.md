# Cahier des Charges — ServiceClient / Alimentation / UpsertSocle
...
Alimentation du SOCLE interactions depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.interactions`

---

## Règles de gestion

- Clé de jointure : `id_interaction`
