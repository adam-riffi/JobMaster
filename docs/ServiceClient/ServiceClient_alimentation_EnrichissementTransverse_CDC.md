# Cahier des Charges — ServiceClient / Alimentation / EnrichissementTransverse
...
Enrichissement du SOCLE interactions avec des données provenant d'autres domaines via jointures SQL transverses.

---

## Sources souhaitées

- Table SOCLE locale : `£BQ_SOCLE.interactions`
...
- Table enrichie : `£BQ_TMP.interactions_enrichi`
