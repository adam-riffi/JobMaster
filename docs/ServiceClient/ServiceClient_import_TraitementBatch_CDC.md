# Cahier des Charges — ServiceClient / Import / TraitementBatch
...
Chargement en masse de tous les fichiers serviceclient validés dans la table staging puis archivage.

---

## Sources souhaitées

- Zone de travail : `C:\data\service_client\work`
...
- Table staging chargée : `£BQ_TMP.staging_interactions`
- Fichiers archivés dans `C:\data\service_client\archive`
