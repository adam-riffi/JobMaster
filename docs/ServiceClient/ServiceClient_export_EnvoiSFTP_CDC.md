# Cahier des Charges — ServiceClient / Export / EnvoiSFTP
...
Envoi des fichiers CSV serviceclient extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\service_client\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/service-client/out`
