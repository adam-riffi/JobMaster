# Cahier des Charges — Consommations / Export / EnvoiSFTP
...
Envoi des fichiers CSV consommations extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\consommations\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/conso/out`
