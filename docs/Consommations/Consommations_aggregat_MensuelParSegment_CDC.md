# Cahier des Charges — Consommations / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE cdr_voix par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£TD_HISTO.cdr_aggr_journalier_client`
