# Cahier des Charges — Portabilite / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs portabilite — utilisé pour les analyses de tendance.

---

## Sources souhaitées

- Table historique : `£TD_HISTO.portages_histo`

---

## Cibles souhaitées

- Table agrégat glissante : `£TD_HISTO.portabilite_aggr_mensuel_operateur`
