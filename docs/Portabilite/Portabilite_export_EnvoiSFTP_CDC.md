# Cahier des Charges — Portabilite / Export / EnvoiSFTP
...
Envoi des fichiers CSV portabilite extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\portabilite\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/portabilite/out`
