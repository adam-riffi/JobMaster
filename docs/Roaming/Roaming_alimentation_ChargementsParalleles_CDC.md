# Cahier des Charges — Roaming / Alimentation / ChargementsParalleles
...
Chargement simultané du SOCLE et de la table historique roaming pour optimiser les temps de traitement.
...
- SOCLE : `£TD_SOCLE.roaming`
- Historique : `£TD_HISTO.roaming_histo`
