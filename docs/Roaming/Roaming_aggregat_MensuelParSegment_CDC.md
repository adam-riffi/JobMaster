# Cahier des Charges — Roaming / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE roaming par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£TD_HISTO.roaming_aggr_mensuel_pays`
