# Cahier des Charges — Incidents / Export / EnvoiSFTP
...
Envoi des fichiers CSV incidents extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\incidents\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/incidents/out`
