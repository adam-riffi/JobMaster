# Cahier des Charges — Incidents / Aggregat / CumulGlissant
...
Calcul du cumul glissant sur 12 mois pour les indicateurs incidents — utilisé pour les analyses de tendance.

---

## Sources souhaitées

- Table historique : `£TD_HISTO.incidents_histo`

---

## Cibles souhaitées

- Table agrégat glissante : `£TD_HISTO.incidents_aggr_journalier_severite`
