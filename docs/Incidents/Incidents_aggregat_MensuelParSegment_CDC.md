# Cahier des Charges — Incidents / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE incidents par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£TD_HISTO.incidents_aggr_journalier_severite`
