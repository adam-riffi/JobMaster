# Cahier des Charges — Clients / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE clients par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£BQ_HISTO.clients_aggr_mensuel`
