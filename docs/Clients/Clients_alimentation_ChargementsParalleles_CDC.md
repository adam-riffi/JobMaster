# Cahier des Charges — Clients / Alimentation / ChargementsParalleles
...
Chargement simultané du SOCLE et de la table historique clients pour optimiser les temps de traitement.
...
- SOCLE : `£BQ_SOCLE.clients`
- Historique : `£BQ_HISTO.clients_histo`
