# Cahier des Charges — Clients / Alimentation / UpsertSocle
...
Alimentation du SOCLE clients depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.clients`

---

## Règles de gestion

- Clé de jointure : `id_client`
