# Cahier des Charges — Paiements / Export / EnvoiSFTP
...
Envoi des fichiers CSV paiements extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\paiements\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/paiements/out`
