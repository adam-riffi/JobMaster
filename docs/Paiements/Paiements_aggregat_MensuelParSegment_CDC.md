# Cahier des Charges — Paiements / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE paiements par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£BQ_HISTO.paiements_aggr_mensuel`
