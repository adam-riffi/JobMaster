# Cahier des Charges — Contrats / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE contrats par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£BQ_HISTO.contrats_aggr_actifs_mensuel`
