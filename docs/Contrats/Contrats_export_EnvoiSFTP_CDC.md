# Cahier des Charges — Contrats / Export / EnvoiSFTP
...
Envoi des fichiers CSV contrats extraits vers le SFTP de distribution partenaire.

---

## Sources souhaitées

- Répertoire source : `C:\data\contrats\export`

---

## Cibles souhaitées

- SFTP destination : `sftp://distribution/contrats/out`
