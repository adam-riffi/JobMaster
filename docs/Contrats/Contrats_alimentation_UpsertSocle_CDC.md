# Cahier des Charges — Contrats / Alimentation / UpsertSocle
...
Alimentation du SOCLE contrats depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£BQ_VUES.contrats`

---

## Règles de gestion

- Clé de jointure : `id_contrat`
