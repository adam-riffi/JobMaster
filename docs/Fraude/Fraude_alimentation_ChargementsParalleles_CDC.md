# Cahier des Charges — Fraude / Alimentation / ChargementsParalleles
...
Chargement simultané du SOCLE et de la table historique fraude pour optimiser les temps de traitement.
...
- SOCLE : `£TD_SOCLE.alertes_fraude`
- Historique : `£TD_HISTO.alertes_fraude_histo`
