# Cahier des Charges — Fraude / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE alertes_fraude par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£TD_HISTO.fraude_aggr_mensuel_type`
