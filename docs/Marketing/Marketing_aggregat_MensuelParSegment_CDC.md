# Cahier des Charges — Marketing / Aggregat / MensuelParSegment
...
Calcul des agrégats mensuels du SOCLE campagnes par dimension métier pour le reporting mensuel.
...
- Table agrégat mensuelle : `£BQ_HISTO.campagnes_aggr_performance_mensuel`
