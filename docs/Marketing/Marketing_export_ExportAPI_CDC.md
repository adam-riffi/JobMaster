# Cahier des Charges — Marketing / Export / ExportAPI
...
Export du SOCLE campagnes vers l'API partenaire en format JSON pour synchronisation temps réel.
...
- API destination : `https://api.marketing-platform.com/push`
- Format : JSON
