# Cahier des Charges — Equipements / Alimentation / UpsertSocle
...
Alimentation du SOCLE equipements depuis la staging par opération MERGE (UPSERT). Mise à jour des existants et insertion des nouveaux.
...
- Vue métier : `£TD_VUES.equipements`

---

## Règles de gestion

- Clé de jointure : `id_equipement`
