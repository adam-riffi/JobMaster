# Cahier des Charges — Equipements / Alimentation / EnrichissementTransverse
...
Enrichissement du SOCLE equipements avec des données provenant d'autres domaines via jointures SQL transverses.

---

## Sources souhaitées

- Table SOCLE locale : `£TD_SOCLE.equipements`
...
- Table enrichie : `£TD_TMP.equipements_enrichi`
